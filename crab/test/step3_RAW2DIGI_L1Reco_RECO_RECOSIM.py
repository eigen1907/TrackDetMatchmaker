...
# with command line options: step3 -s RAW2DIGI,L1Reco,RECO,RECOSIM --datatier GEN-SIM-RECO --era Run3_2024 --conditions auto:phase1_2024_realistic --geometry DB:Extended --eventcontent RECOSIM -n 10 --filein file:step2.root --fileout file:step3.root

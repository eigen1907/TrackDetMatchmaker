...
# with command line options: SingleMuPt1_pythia8_cfi -s GEN,SIM --datatier GEN-SIM --era Run3_2024 --conditions auto:phase1_2024_realistic --beamspot DBrealistic --geometry DB:Extended --eventcontent FEVTDEBUG --relval 25000,100 -n 10 --fileout file:step1.root

...
# with command line options: step2 -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2024 --datatier GEN-SIM-DIGI-RAW --era Run3_2024 --conditions auto:phase1_2024_realistic --geometry DB:Extended --eventcontent FEVTDEBUGHLT -n 10 --filein file:step1.root --fileout file:step2.root

...
process.BetafuncEvtVtxGenerator = cms.EDProducer("BetafuncEvtVtxGenerator",
    Alpha = cms.double(0),
...
process.schedule = cms.Schedule(*[ process.generation_step, process.genfiltersummary_step, process.simulation_step, process.endjob_step, process.FEVTDEBUGoutput_step ], tasks=[process.patAlgosToolsTask])
